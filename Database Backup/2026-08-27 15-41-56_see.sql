...
MySQL - 5.7.27-log : Database - seedb
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`seedb` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
('7dbb16a8ed03601cb4c2cf299fd95404','i:1;',1787802519),
('7dbb16a8ed03601cb4c2cf299fd95404:timer','i:1787802519;',1787802519);
...
CREATE TABLE `chief_complaints` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_chief_complaint_name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=latin1;

/*Data for the table `chief_complaints` */

insert  into `chief_complaints`(`id`,`name`,`description`,`is_active`,`created_at`,`updated_at`) values 
(1,'Blurred Vision',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(2,'Decreased Vision',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(3,'Eye Pain',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(4,'Eye Redness',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(5,'Eye Itching',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(6,'Watery Eyes',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(7,'Dry Eyes',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(8,'Floaters',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(9,'Flashes of Light',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(10,'Double Vision',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(11,'Headache',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(12,'Difficulty Reading',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(13,'Foreign Body Sensation',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(14,'Light Sensitivity',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(15,'Eye Discharge',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(16,'Swelling of Eye',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(17,'Distorted Vision',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(18,'Loss of Vision',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(19,'Glare',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45'),
(20,'Difficulty Seeing at Night',NULL,1,'2026-08-14 09:36:45','2026-08-14 09:36:45');
...
CREATE TABLE `doctors` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_license_no` (`license_no`),
  KEY `doctors_ibfk_1` (`user_id`),
  CONSTRAINT `doctors_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `employees` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `doctors` */

insert  into `doctors`(`id`,`license_no`,`specialization`,`contact_no`,`is_active`,`created_at`,`updated_at`,`user_id`) values 
(1,'123','OPTA','132',1,'2026-08-14 08:18:44','2026-08-14 08:18:44',14);
...
/*Table structure for table `glasses_inventory` */

DROP TABLE IF EXISTS `glasses_inventory`;

CREATE TABLE `glasses_inventory` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
/*Data for the table `glasses_inventory` */

insert  into `glasses_inventory`(`id`,`code`,`brand`,`model`,`description`,`color`,`quantity`,`available_quantity`,`cost_price`,`selling_price`,`is_active`,`created_at`,`updated_at`) values 
(1,'FR-001','Generic','Classic-01','Classic Full Frame','Black',5,4,1500.00,3000.00,1,'2026-08-23 09:07:27','2026-08-23 09:46:36'),
(2,'FR-002','Generic','Glass-01','Retro full frame','white',3,0,1200.00,2800.00,1,'2026-08-23 09:43:23','2026-08-27 10:19:57');

/*Table structure for table `glasses_order_tracking` */

DROP TABLE IF EXISTS `glasses_order_tracking`;

CREATE TABLE `glasses_order_tracking` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `glasses_order_id` bigint(20) unsigned NOT NULL,
  `status` varchar(50) NOT NULL,
  `remarks` text,
  `created_by` bigint(20) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_glasses_order_tracking_order` (`glasses_order_id`),
  CONSTRAINT `glasses_order_tracking_order_fk` FOREIGN KEY (`glasses_order_id`) REFERENCES `glasses_orders` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4;

/*Data for the table `glasses_order_tracking` */

insert  into `glasses_order_tracking`(`id`,`glasses_order_id`,`status`,`remarks`,`created_by`,`created_at`) values 
(1,6,'Ordered','Glasses order created.',NULL,'2026-08-23 01:54:13'),
(2,6,'Sent to Lab',NULL,1,'2026-08-23 02:03:36'),
(3,6,'On Route to Clinic',NULL,1,'2026-08-23 02:22:23'),
(4,6,'On Clinic',NULL,1,'2026-08-23 02:23:02'),
(5,6,'Given to Patient',NULL,1,'2026-08-23 02:23:10'),
(6,5,'Ordered',NULL,1,'2026-08-23 02:29:52'),
(7,5,'Sent to Lab',NULL,1,'2026-08-23 02:29:58'),
(8,5,'Given to Patient',NULL,1,'2026-08-23 02:30:06'),
(9,6,'Returned - Defective','na',1,'2026-08-23 02:36:35'),
(10,6,'Given to Patient',NULL,1,'2026-08-23 02:45:29'),
(11,7,'Ordered','Glasses order created.',NULL,'2026-08-27 02:19:57'),
(12,7,'Sent to Lab',NULL,1,'2026-08-27 02:33:54');

/*Table structure for table `glasses_orders` */

DROP TABLE IF EXISTS `glasses_orders`;
...
CREATE TABLE `glasses_orders` (
  ...
  `sent_to_lab_at` datetime DEFAULT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_glasses_visit` (`visit_id`),
  KEY `idx_glasses_status` (`status`),
  KEY `glasses_orders_frame_fk` (`frame_id`),
  CONSTRAINT `glasses_orders_frame_fk` FOREIGN KEY (`frame_id`) REFERENCES `glasses_inventory` (`id`),
  CONSTRAINT `glasses_orders_visit_fk` FOREIGN KEY (`visit_id`) REFERENCES `visits` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4;

/*Data for the table `glasses_orders` */

insert  into `glasses_orders`(`id`,`visit_id`,`frame_id`,`description`,`serial_no`,`additional_features`,`unit_price`,`status`,`ordered_at`,`sent_to_lab_at`,`on_route_at`,`received_at`,`released_at`,`created_at`,`updated_at`) values 
(4,6,2,NULL,NULL,NULL,2800.00,'Ordered','2026-08-23 01:33:06',NULL,NULL,NULL,NULL,'2026-08-23 01:33:06','2026-08-23 01:46:36'),
(5,4,1,NULL,NULL,NULL,3100.00,'Given to Patient','2026-08-23 02:29:52','2026-08-23 02:29:58',NULL,NULL,'2026-08-23 02:30:06','2026-08-23 01:33:40','2026-08-23 02:30:06'),
(6,7,2,NULL,NULL,NULL,2800.00,'Given to Patient','2026-08-23 01:54:13','2026-08-23 02:03:36','2026-08-23 02:22:23','2026-08-23 02:23:02','2026-08-23 02:45:29','2026-08-23 01:54:13','2026-08-23 02:45:29'),
(7,8,2,NULL,'89898989','UV Protection',5800.00,'Sent to Lab','2026-08-27 02:19:57','2026-08-27 02:33:54',NULL,NULL,NULL,'2026-08-27 02:19:57','2026-08-27 02:33:54');
...
(1,'PCC at CLSU','CLSU',NULL,'A',NULL,NULL,NULL,NULL),
(2,'PCC at VSU','VSU',NULL,'A',NULL,NULL,NULL,NULL),
...
insert  into `patients`(`id`,`first_name`,`middle_name`,`last_name`,`suffix`,`birth_date`,`sex`,`address`,`contact_no`,`email`,`is_active`,`created_at`,`updated_at`) values 
(1,'Luna','s','DTM',NULL,'2026-08-14','M',NULL,'123',NULL,1,'2026-08-14 08:21:44','2026-08-14 08:21:44'),
(2,'gambito','nose','jing',NULL,'2019-12-30','Male','capitol','444',NULL,1,'2026-08-14 04:43:57','2026-08-14 04:43:57'),
(7,'tam an','c','tomas',NULL,'2026-08-01','Male','mountains','555',NULL,1,'2026-08-14 04:56:08','2026-08-14 04:56:08'),
(8,'Eufemia',NULL,'Dacayo',NULL,'2014-01-14','Female','Solano','789',NULL,1,'2026-08-14 06:57:55','2026-08-14 06:57:55'),
'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36','',1787802580);
...
(1,'ED','Executive Director III',NULL,1,'A',NULL,NULL,'2025-04-25 08:58:48',1),
(2,'BO','Budget Officer',NULL,1,'A',NULL,NULL,'2025-04-25 08:58:31',1);
...
insert  into `users`(`id`,`employeeid`,`email`,`email_verified_at`,`password`,`type`,`areaid`,`two_factor_secret`,`two_factor_recovery_codes`,`two_factor_confirmed_at`,`remember_token`,`created_at`,`updated_at`,`allowmodificationapproval`,`allowobligationapproval`,`locationid`) values 
(1,14,'gian@gmail.see',NULL,'$2y$12$murVGd6FJyZqAYs3HUu/j.9u.nhiwf82CLDH8tmpd3qa/0NM.giB.','Administrator',NULL,NULL,NULL,NULL,'YcWAwfZ9DRxLlWcUIWVjJUHqm4y4LCA1byKjWDGn6mUOLSQQU1RYVwDvItdD','2024-06-09 12:37:42','2025-05-14 07:28:55',0,0,1);
...
CREATE TABLE `visits` (
  ...
  `visit_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Consultation',
  `chief_complaint_id` int(20) unsigned DEFAULT NULL,
  `visual_acuity_od` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `visual_acuity_os` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `iop_od` decimal(5,2) DEFAULT NULL,
  `iop_os` decimal(5,2) DEFAULT NULL,
  `external_exam` text COLLATE utf8mb4_unicode_ci,
  `anterior_segment` text COLLATE utf8mb4_unicode_ci,
  `fundus_exam` text COLLATE utf8mb4_unicode_ci,
  `other_findings` text COLLATE utf8mb4_unicode_ci,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `chief_complaint_id` (`chief_complaint_id`),
  CONSTRAINT `visits_ibfk_1` FOREIGN KEY (`chief_complaint_id`) REFERENCES `chief_complaints` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

/*Data for the table `visits` */

insert  into `visits`(`id`,`patient_id`,`doctor_id`,`visit_date`,`visit_time`,`visit_type`,`chief_complaint_id`,`visual_acuity_od`,`visual_acuity_os`,`iop_od`,`iop_os`,`external_exam`,`anterior_segment`,`fundus_exam`,`other_findings`,`diagnosis`,`treatment`,`notes`,`follow_up_date`,`created_at`,`updated_at`) values 
(1,1,1,'2026-08-14','09:57:00','Consultation',NULL,'20','20',20.00,16.00,'0','0','0','0','test','test1',NULL,'2026-08-22','2026-08-14 01:58:05','2026-08-23 01:29:04'),
(2,1,1,'2026-08-07','09:58:00','Eye Examination',NULL,'20','20',20.00,20.00,'1','1','1','1','test2','test3',NULL,'2026-08-14','2026-08-14 01:59:40','2026-08-14 01:59:40'),
(3,1,1,'2026-08-14','10:07:00','Consultation',2,'20/10','20',20.00,20.00,NULL,NULL,NULL,NULL,'tset6','test6',NULL,'2026-08-28','2026-08-14 02:08:09','2026-08-14 02:35:38'),
(4,7,1,'2026-08-14','12:56:00','Consultation',12,'10','10',10.00,10.00,NULL,NULL,NULL,NULL,'glasses','paracetamol',NULL,'2026-09-01','2026-08-14 05:00:32','2026-08-23 01:47:32'),
(6,8,1,'2026-08-19',NULL,'Consultation',10,'4','4',4.00,4.00,NULL,NULL,NULL,NULL,'test new',NULL,NULL,NULL,'2026-08-19 07:07:57','2026-08-23 01:46:36'),
(7,2,1,'2026-08-23','09:53:00','Consultation',1,'1','1',1.00,1.00,'1','1','1','1','test',NULL,NULL,'2026-09-01','2026-08-23 01:54:13','2026-08-23 01:54:13'),
(8,9,1,'2026-08-27','10:19:00','Consultation',14,'5','5',5.00,5.00,'5','5','5','5','headache','paracetamol',NULL,'2026-09-01','2026-08-27 02:19:57','2026-08-27 02:19:57');
