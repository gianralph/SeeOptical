        ...
        <template #content>
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    ...
                    <div class="mt-4">
                        <v-text-field ref="passwordInput" v-model="form.password" type="password" class="mt-1 w-3/4" label="Password"
                            autocomplete="current-password" @keyup.enter="logoutOtherBrowserSessions"
                            :error-messages="form.errors.password ? [form.errors.password] : []" autofocus/>
                    </div>
                </template>
